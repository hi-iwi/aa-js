...
/**
 *
 * @param {undefined|string|{[key:string]:any}} vv
 * @param vk
 * @param defaultV
 * @returns {null|*}
 */
...
class map {
    ...
    size // {number}
    /**
     * @param {{[key:string]:any} | string} o
     */
    constructor(o = {}) {
        this.object = this.#parse(o)
    ...
    #parse(o) {
        ...
        try {
            ...
            console.error("invalid new map object", o)
        }
        return {}
    }
    ...
    // 深度复制
    clone() {
        let o = JSON.parse(JSON.stringify(this.object))
        return new map(o)
    }
